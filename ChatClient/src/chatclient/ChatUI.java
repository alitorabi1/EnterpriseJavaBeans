...
public class ChatUI extends javax.swing.JFrame {
    ...
    public ChatUI() {
        try {
            ...
            chatService = (ChatEJBRemote) ctx.lookup(ChatEJBRemote.class.getName());
            //
            initComponents();
    ...
    private void initComponents() {
        ...
        jlChats.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(jlChats);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            chatService.addChat(name, chat, df.format(dateobj));
            list = chatService.getChat();


            DefaultListModel model = new DefaultListModel();
            for (Chat c : list) {
                model.addElement(String.format("%s: %s      %s", c.name, c.chat, c.date.toString()));
            }
            jlChats.setModel(model);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            DefaultListModel listModel = (DefaultListModel) jlChats.getModel();
    ...
    private javax.swing.JList<String> jlChats;
